          ...
          data.ideas.forEach(idea => {
            ...
            if (!ideaMap.has(idea.session_id)) {
              ...
              ideaMap.set(idea.session_id, {
                ...
                evaluationScore: idea.metadata?.evaluation_score || idea.evaluation_score || null,
              ...
              >
                <div className="p-6">
                  ...
                  <div className="space-y-2 text-sm text-gray-500">
                    ...
                    {idea.evaluationScore && (
                      <div className="flex justify-between">
                        <span>Score:</span>
                        <span className={`font-medium ${idea.evaluationScore >= 70 ? 'text-green-600' : idea.evaluationScore >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-500">
                      ...
                      {selectedIdea.evaluationScore && (
                        <div>
                          ...
                          <span className={`ml-1 ${selectedIdea.evaluationScore >= 70 ? 'text-green-600' : selectedIdea.evaluationScore >= 50 ? 'text-yellow-600' : 'text-red-600'}`}>
